...
def run_simulation(
    ...
    if not dispatch_lg.empty:
        ...
        # ensure Quantity_tons exists and numeric
    ...
    # Combine pre and main LG stock levels
    ...
    # Normalize dtypes: Day -> int, Entity_ID -> int where possible, Stock_Level_tons -> float
